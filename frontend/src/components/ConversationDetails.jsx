...
const ConversationDetails = ({ removeParticipant, goToPage, callUser }) => {
    ...
    const getUser = () => {
        if (selectedChat.users[0]._id === userDetails._id)
            ...
            <div className="detail-area-header">
                ...
                <div className="detail-buttons">
                    <button className="detail-button" onClick={() => {
                        ...
                        //     .then((stream) => {
                        //         setLocalStream(new MediaStream([...localStreams, stream]))
                        //     })

                        callUser(getUser()._id, userDetails._id, userDetails.name)
                    }
                    }>
                    ...
                    <button className="detail-button" onClick={() => { nav('/call/ongoing') }}>
