...
const VideoCall = () => {
    ...
    const getUser = () => {
        return user._id === '649cf0d2fa6491ad4e00654c' ? '649d019fd2bff116c53b563d' : '649cf0d2fa6491ad4e00654c'
    }
    ...
    const toggleVideo = () => {
        ...
        // showMyVideo ? myVideo.current.pause() : myVideo.current.play();

        // setShowMyVideo(!showMyVideo)
        // console.log(myVideo);
        // if (showMyVideo) { myVideo.current.srcObject = stream }
    }

    return (
        // <NewWindow>
        <div className="fullscreen-media-container video w-100" style={{ height: "100vh" }}>
            ...
            <div className="overlay-content-container">
                ...
                <div className="ui-container">
                    <div className="navigation-controls-container">
                        <button className="call-button button-settings me-3" onClick={() => callUser(getUser(), user._id, user.name)}>
                            <span></span>
                        </button>
                        ...
                        <button className="call-button button-share-element">
                        ...
                        <button className='call-button bg-light rounded-pill' onClick={() => answerCall()}>
